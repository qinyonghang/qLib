...
set(${LIB_NAME}_CMAKE_ARGS "\"-DSPDLOG_BUILD_SHARED=OFF\" \"-DBUILD_SHARED_LIBS=OFF\"")
...
message(STATUS "Linked ${LIB_NAME} for qlib. ROOT=${${LIB_NAME}_INSTALL_DIR}")
target_link_libraries(qlib PUBLIC spdlog::spdlog)

install(DIRECTORY ${${LIB_NAME}_INSTALL_DIR}/include DESTINATION .)
install(DIRECTORY ${${LIB_NAME}_INSTALL_DIR}/lib DESTINATION .)
